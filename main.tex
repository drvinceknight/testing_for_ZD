...
\affil[3]{Max Planck Research Group on the Dynamics of Social Behavior, Max
Planck Institute for Evolutionary Biology, Pl\"on, Germany}
\date{\today}
...
Based on Equations (\ref{eqn:condition_for_chi}-\ref{eqn:condition_for_p4}), 
...
\begin{figure}[!htbp]
    ...
    \caption{\(\SSe\) and probability of mutual defection (\(P(DD)\)) 
