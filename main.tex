...
is as a question of direct reciprocity, a viewpoint
...
most studies of the effectiveness of zero-determinant strategies is done by
evaluating the performance of specific zero-determinant strategies 
against a collection of agents either numerically or theoretically.

Extortionate strategies are algebraically rigid and memory-one by definition.
Determinining if a strategy is extortionate requires complete knowledge of
the strategy (the memory-one cooperation probabilities). We present a method to detect
