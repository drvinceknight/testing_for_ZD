...
% TODO Replace this discussion with the algebraic result for the planar
% relationship for $p_1=k_1 + k_2p_2 + k_3p_2$
...
\begin{equation}\label{eqn:inverse_of_C4}
    C_{(4)}^{-1} =
    \input{./assets/tex/inverse_of_C4/main.tex}
\end{equation}
...
% TODO Change this discussion to deal with the correct C matrix for computing
% extortionate strategies
% The matrix below will correspond to the equations we write down above in
% explanation about planar work
%\begin{equation}\label{eqn:definition_of_C}
    %C =
    %\begin{bmatrix}
        %R - P & R- P \\
