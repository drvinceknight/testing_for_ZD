...
Next we investigate a tournament with \input{assets/tex/number_of_full_strategies/main.tex}strategies. The
...
Note that while a strategy may attempt to act
...
% TODO This section needs to be rephrased.
