...
given in equation~\ref{eqn:theipd}, where the constraints ensure a non
...
An initial major piece of research on this topic was the work
of~\cite{Axelrod1980, Axelrod1980a} which show that a cooperative behaviour
...
One specific type of these strategies are zero-determinant (ZD) strategies which
were introduced in \cite{Press2012}, extortionate strategies have received
