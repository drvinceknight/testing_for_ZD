...
of~\cite{Press2012} is that given two memory one players \(p, q\in\mathbb{R}^4\)
a linear relationship between the players' scores can be forced by one of the
players.
...
\includepdf{assets/pdf/proof_of_optimal_values_of_SS_alpha_and_beta/main.pdf}
