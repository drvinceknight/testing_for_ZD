...
In~\cite{Press2012} a class of strategies that can provably extort any given
opponent was described. In~\cite{Hilbe2013, Moran1707} some questions have
...
presented: this reflects the way that the continued actions of an extortionate
...
acting extortionately. Suspicion of extortion then corresponds to a threshold
on \(\text{SS}_{\text{error}}\). Comparing theoretic and actual plays of the
...
\begin{figure}[!htbp]
    ...
    are displayed. Note that \(P(DC)\) is not shown as it corresponds to the
    transpose of \(P(CD)\).}
...
Whilst the elegance of this result is very attractive, just as the simplicity of
...
not achieve a high score which corresponds to the fitness landscape in an
...
a simple set of rules. The discover/definition of extortionate
strategies~\cite{Press2012} seemingly showed that simple strategies could be
taken advantage of. In this manuscript it has been shown that not only is it
possible to be suspicious of extortionate strategies but that more complex
