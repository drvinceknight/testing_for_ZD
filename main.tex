...
Section~\ref{sec:numerical-experiments} are open sourced, archived, and written
...
\begin{table}[!hbtp]
    ...
    \caption{Summary of results for a selected list of strategies. Similarly to
        ...
        Figure~\ref{fig:sserror_in_selection}).} % TODO: remove reference? Figure is not included anymore?
