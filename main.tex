...
% TODO Point at (and write) extra materials for proof of this
% TODO Write function that checks this exact condition.

% TODO Add comment about how this corresponds to "on average" cooperating less
% than 50% of the time when doing different action to opponent.

% TODO Show what this corresponds to for RTSP=3501.
...
this case all the constraints hold.
